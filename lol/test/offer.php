...
$query = mysql_query("SELECT offer_name, offer_userid, offer_desc, offer_album, offer_avatar, offer_date FROM wc__offers WHERE offer_id = '".intval($_GET['id'])."' LIMIT 1");
$showoffer = mysql_fetch_assoc($query);
...
$avatarpreview = '/userupload/uploads/'.$avatarparcing['user_avatar'].$definition;// width="75" height="75"
...
<title><?echo $showoffer['offer_name']?></title>
...
<div id="wb_UserInfo">
<div id="wb_username">
<?echo $showoffer['offer_name']?>
<br>
<div id="wb_usercity">
<?echo $showoffer['offer_desc']?>
<br>
...
$offer_name = $showoffer['offer_name'];
...
<input type="submit" id="Button2" name="save" value="Разместить" class="mail_but">
</div>
</form>
<div id="wb_Image11">
